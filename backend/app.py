...
def upload_image():
    ...
    inference_results = run_inference(master_image_path)
    ...
    # Generate depth map
    depth = generate_depth_map(master_image_path, inference_results['mask'])
    depth_filename = None
    ...
    return jsonify(
        {
            ...
            "filename": os.path.basename(master_image_path),
