...
export default function BudgetOptimizer() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginTop: 12 }}>
      ...
      {/* ── Header Card ── */}
      <div className="sim-panel glow-panel" style={{ padding: '28px 32px', background: '#0d1528', color: '#fff' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
              ...
              <div>
                <h2 style={{ fontFamily: "'Orbitron', monospace", fontSize: 20, fontWeight: 700, margin: 0, color: '#fff' }}>
        ...
        <div style={{ marginTop: 24, background: 'rgba(255,255,255,0.02)', padding: '20px 24px', borderRadius: 14, border: '1px solid var(--border)' }}>
          ...
          <input 
            ...
            style={{ width: '100%', cursor: 'pointer', accentColor: '#00d4ff', height: 6, borderRadius: 3, background: 'rgba(0,0,0,0.2)', appearance: 'none', outline: 'none' }}
          />
      ...
      {result && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
          ...
          <div className="sim-panel glow-panel" style={{ padding: 20, background: '#0d1528', borderTop: '2px solid var(--accent-blue)', color: '#fff' }}>
          ...
          <div className="sim-panel" style={{ padding: 20, background: '#0d1528', borderTop: '2px solid #f59e0b', color: '#fff' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
          ...
          <div className="sim-panel" style={{ padding: 20, background: '#0d1528', borderTop: '2px solid #10b981', color: '#fff' }}>
             <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
          ...
          <div className="sim-panel" style={{ padding: 20, background: '#0d1528', borderTop: '2px solid var(--accent-purple)', color: '#fff' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
      ...
      {result && result.selected_structures.length > 0 && (
        <div style={{ padding: 24, borderRadius: 16, border: '1px solid var(--border-glow)', background: '#0d1528', boxShadow: 'var(--shadow-glow)' }}>
      ...
      <div className="sim-panel" style={{ padding: 0, background: '#0d1528', color: '#fff' }}>
