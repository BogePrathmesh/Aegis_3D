    ...
    <header className="w-full top-0 sticky z-50 bg-white/90 backdrop-blur-md border-b border-outline-variant/10 transition-colors duration-300">
      <div className="flex justify-between items-center w-full px-8 py-4 max-w-[1440px] mx-auto">
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center hover:scale-105 transition-transform" title="Profile">
            <span className="material-symbols-outlined text-slate-600 text-3xl hover:text-primary transition-colors cursor-pointer">
              account_circle
            </span>
          </div>
          <NavLink to="/login" className="flex items-center hover:scale-110 transition-transform" title="Sign Out">
            <span className="material-symbols-outlined text-slate-400 cursor-pointer text-2xl hover:text-rose-500 transition-colors">
              logout
            </span>
          </NavLink>
        </div>
